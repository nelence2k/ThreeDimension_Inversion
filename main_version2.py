...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("MEMS Beam Thermal Demo - Version 2")
    ...
    def _build_right_panel(self):
        ...
        tip_text = QLabel(
            ...
            "4. Save or load parameter sets as JSON"
        )
    ...
    def _show_initial_geometry(self):
        ...
        try:
            ...
            self.statusBar().showMessage("Initial geometry loaded")
    ...
    def save_parameters(self):
        ...
        file_path, _ = QFileDialog.getSaveFileName(
            self,
            "Save Parameters",
            str(Path.cwd() / "mems_beam_params.json"),
            "JSON Files (*.json)",
        )
    ...
    def show_about_dialog(self):
        QMessageBox.information(
            self,
            "About",
            "MEMS Beam Thermal Demo - Version 2\n\n"
            "Features:\n"
